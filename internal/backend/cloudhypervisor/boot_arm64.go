...
// cloud image on aarch64. console=ttyAMA0 targets the pl011 UART cloud-hypervisor
// exposes on aarch64 (so the serial log fills); root is the first virtio-blk
...
// deferred (ADR-0029).
const bootCmdline = "console=ttyAMA0 root=/dev/vda1 rw"
