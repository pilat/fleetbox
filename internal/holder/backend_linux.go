...
// dir, and caches the pinned VMM binary + firmware under the bin dir. The holder
// is the only thing that links it, reached on Linux by the CLI/test binary
// re-execing itself as the holder (ADR-0020).
